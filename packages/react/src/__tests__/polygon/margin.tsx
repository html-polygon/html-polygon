...
describe('react', () => {
  describe('polygon', () => {
    it('correctly renders a margin', () => {
      // render the polygon
      const result = render(<Polygon dataTestId='test' sides={3} margin={5} />)

      // there should be a polygon with a clip-path that starts at a certain
      // position
